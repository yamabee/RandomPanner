...
public:
    ...
    virtual void drawRotarySlider(Graphics &g, int x, int y, int width, int height, float sliderPos, float rotaryStartAngle, float rotaryEndAngle, Slider &slider) override {
        
        Image knob;

        knob = ImageCache::getFromMemory(BinaryData::maschineLimeSmall_png, BinaryData::maschineLimeSmall_pngSize);
